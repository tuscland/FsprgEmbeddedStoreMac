...
@interface FsprgStoreParameters ()

@property (nonatomic, readwrite, strong) NSMutableDictionary *raw;
...
+ (void)initialize
{
    ...
    dispatch_once(&onceToken, ^{
        ...
        NSSet *toURLSet = [NSSet setWithObjects:
                           NSStringFromSelector(@selector(language)),
